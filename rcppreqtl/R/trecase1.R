`trecase1irw_b0` = function(trc, asn, asnp, thp, Xmatr, est.inits=TRUE,inits=NULL)
{
  nInd = length(trc)
  nAse = length(asn)
  nGenes = 1
  ...
  Z = .C("max_trecase1irw_b0", as.integer(nInd), as.integer(nAse), as.integer(nGenes), as.integer(thp), as.double(trc),as.double(asn),as.double(asnp),
  as.integer(nPar),optval=as.double(inits),as.double(Xmatr), as.integer(est.inits), PACKAGE="rcppreqtl")
  #cat("returned: ",Z$optval,"\n")
  return(Z$optval)
}

`trecase1irw_b1` = function(trc, asn, asnp, thp, Xmatr, est.inits=TRUE,inits=NULL, b0=0)
{
  nInd = length(trc)
  nAse = length(asn)
  nGenes=length(b0)
  ...
  Z = .C("max_trecase1irw_b1", as.integer(nInd), as.integer(nAse), as.integer(nGenes), as.integer(thp), as.double(trc),as.double(asn),as.double(asnp),
  as.integer(nPar),optval=as.double(inits),as.double(Xmatr), as.integer(est.inits),as.double(b0), PACKAGE="rcppreqtl")
  #cat("returned: ",Z$optval,"\n")
  return(Z$optval)
}

`trecase1irw_b01` = function(trc, asn, asnp, thp, Xmatr, est.inits=TRUE,inits=NULL)
{
  nInd = length(trc)
  nAse = length(asn)
  nGenes=1
  ...
  Z = .C("max_trecase1irw_b01", as.integer(nInd), as.integer(nAse), as.integer(nGenes), as.integer(thp), as.double(trc),as.double(asn),as.double(asnp),
  as.integer(nPar),optval=as.double(inits),as.double(Xmatr), as.integer(est.inits), PACKAGE="rcppreqtl")
  #cat("returned: ",Z$optval,"\n")
  return(Z$optval)
}
